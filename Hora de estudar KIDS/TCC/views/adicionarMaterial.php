    ...
    <?php 
     if (isset($_SESSION['erroM'])) {
      echo "<div class='alert alert-danger' style='height: 40px, width:70%;'>
          $_SESSION[erroM] </div> ";
     unset($_SESSION['errosM']);
    }
    if (isset($_SESSION['sucessosM'])) {
      echo "<div class='alert alert-success' style='height: 50px;'>
          $_SESSION[sucessoM]
      </div> ";
      unset($_SESSION['sucessoM']);
    }
    ?>
    </div>
    <br>

    <form enctype="multipart/form-data" action="../controller/adicionarMaterial.php" method="POST" style="margin-left: 10%; max-width: 70%;">
    <input type="hidden" name="id_admin" value="<?php echo "$id"  ?>">
        <h2 style="margin-top: 20px; margin-left:25%">Adicione um Material:</h2><br>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="link" placeholder="Adicione o incorporar do Youtube aqui" required>
        </div><br>
        <div class="form-group">
            <label><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" color="#ffa710" class="bi bi-mortarboard" viewBox="0 0 16 16">
                    <path d="M8.211 2.047a.5.5 0 0 0-.422 0l-7.5 3.5a.5.5 0 0 0 .025.917l7.5 3a.5.5 0 0 0 .372 0L14 7.14V13a1 1 0 0 0-1 1v2h3v-2a1 1 0 0 0-1-1V6.739l.686-.275a.5.5 0 0 0 .025-.917l-7.5-3.5ZM8 8.46 1.758 5.965 8 3.052l6.242 2.913L8 8.46Z" />
